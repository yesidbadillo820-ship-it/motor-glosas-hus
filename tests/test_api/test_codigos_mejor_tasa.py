"""Tests del endpoint GET /glosas/stats/codigos-mejor-tasa (R230 P1)."""
...
class TestCodigosMejorTasa:
    def test_orden_desc(self, client, db_session):
        ...
        r = client.get("/glosas/stats/codigos-mejor-tasa?min_decididas=1")
        d = r.json()
        assert d["items"][0]["codigo_glosa"] == "BUENO"
