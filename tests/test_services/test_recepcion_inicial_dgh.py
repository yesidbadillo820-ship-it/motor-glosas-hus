...
_FILA = [
    ...
    "HUS0000494973", "171863", " 1.211.302 ", "14/05/2026", "N", "8",
    "", "", "", "ELIAS ALFONSO CARVAJAL NAVARRO", "", "Administrativo",
]
...
def _excel_dgh_real() -> bytes:
    ...
    ws.append(_FILA[:6] + ["HUS0000495362", "171865", " 5.892.038 ",
                            "14/05/2026", "N", "8", "", "", "",
...
def test_inicial_con_encabezado_mas_alla_de_fila_5_se_importa(db_session):
    ...
    g = (
        ...
        .filter(GlosaRecord.factura == "HUS0000494973")
        .first()
    )
