...
class TestUserPrompt:
    ...
    def test_build_user_prompt_basic(self):
        ...
        prompt = build_user_prompt(
            texto_glosa="GLOSA TA0201", contexto_pdf="", codigo="TA0201", eps="EPS TEST"
        )
    ...
    def test_build_user_prompt_con_pdf(self):
        ...
        prompt = build_user_prompt(
            texto_glosa="GLOSA", contexto_pdf=pdf_context, codigo="CO0001", eps="EPS TEST"
        )
    ...
    def test_build_user_prompt_instrucciones(self):
        ...
        prompt = build_user_prompt(
            texto_glosa="GLOSA", contexto_pdf="", codigo="FA0001", eps="EPS TEST"
        )
