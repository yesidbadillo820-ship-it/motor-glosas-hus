...
class ConciliacionRepository:
    ...
    def crear(
        ...
        c = ConciliacionRecord(
            ...
            lugar=lugar,
            participantes_hus=participantes_hus,
            participantes_eps=participantes_eps,
            resultado=resultado,
    ...
    def obtener_por_id(self, conciliacion_id: int):
        return (
            self.db.query(ConciliacionRecord)
            .filter(ConciliacionRecord.id == conciliacion_id)
            .first()
        )
    ...
    def listar_por_glosa(self, glosa_id: int):
        return (
            ...
            .order_by(desc(ConciliacionRecord.creado_en))
            .all()
        )
    ...
    def estadisticas(self) -> dict:
        resultados = (
            ...
            .group_by(ConciliacionRecord.resultado)
            .all()
        )
