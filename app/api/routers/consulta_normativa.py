...
CATALOGO_NORMAS = [
    ...
    # ─── LEYES ───
    {
        ...
        "vigente": True,
        "keywords": ["seguridad social", "salud", "EPS", "IPS", "Art. 177", "Art. 168", "urgencias"],
    },
    {
    ...
    },
    {
        ...
        "vigente": True,
        "keywords": ["glosas", "plazos", "conciliación", "Art. 56", "Art. 57", "Art. 105", "Art. 126", "SuperSalud"],
    },
    {
    ...
    # ─── DECRETOS ───
    {
        ...
        "vigente": True,
        "keywords": ["glosas", "urgencias", "conciliación", "sustentación", "Art. 11", "Art. 20", "Art. 21"],
    },
    {
