...
_EPS_PALABRAS_NO_NOMBRE: frozenset[str] = frozenset(
    {
        ...
        "RECONOCER", "RECONOCERA", "RECONOCERÁ", "RECONOCERAN", "RECONOCERÁN",
        "RECONOZCAN", "RECONOZCA",
        "PAGAR", "PAGARA", "PAGARÁ", "PAGARAN", "PAGARÁN",
        "ESTABLECE", "ESTABLECEN", "ESTABLECEN", "ESTABLECER", "ESTABLECIO",
        "ESTABLECIÓ", "ESTABLECIDA", "ESTABLECIDAS", "ESTABLECIDO", "ESTABLECIDOS",
        "DEBE", "DEBEN", "DEBERA", "DEBERÁ", "DEBERAN", "DEBERÁN",
        "DEBERIA", "DEBERÍA", "DEBIERA", "DEBIERAN",
        "APLICA", "APLICAN", "APLICAR", "APLICARA", "APLICARÁ", "APLICARAN",
        "APLICANDO", "APLICÓ", "APLICO",
        "PRETENDE", "PRETENDEN", "PRETENDIO", "PRETENDIÓ",
        "ARGUMENTA", "ARGUMENTAN", "ARGUMENTÓ", "ARGUMENTO",
        "OBJETA", "OBJETAN", "OBJETÓ", "OBJETO",
        "NIEGA", "NIEGAN", "NEGÓ", "NEGO",
        "AFIRMA", "AFIRMAN", "AFIRMÓ", "AFIRMO",
        "ALEGA", "ALEGAN", "ALEGÓ", "ALEGO",
        "SOSTIENE", "SOSTIENEN", "SOSTUVO",
        "INCURRE", "INCURREN", "INCURRIÓ", "INCURRIO",
        "TIENE", "TIENEN", "TUVO",
        "VULNERA", "VULNERAN",
        "OMITE", "OMITEN",
        ...
        "LEGALMENTE", "UNILATERALMENTE", "EXPRESAMENTE",
        "OBLIGADAS", "OBLIGADA", "OBLIGADOS", "OBLIGADO",
        # Conectores y demás
        "PERO", "MAS", "AUN", "AÚN", "SIN", "PARA", "POR", "CON", "DE",
        "QUE", "QUIEN", "QUIENES", "CUYO", "CUYA", "CUYOS", "CUYAS",
        # Pronombres
        "ELLA", "ELLAS", "ELLOS", "TODAS", "TODOS", "AMBAS", "AMBOS",
