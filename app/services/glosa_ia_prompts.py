...
PÁRRAFO 1 — IDENTIFICACIÓN: Inicia EXACTAMENTE con "ESE HUS NO ACEPTA LA GLOSA APLICADA POR CONCEPTO DE [TIPO COMPLETO] SOBRE EL CÓDIGO [CÓDIGO], INTERPUESTA POR [ENTIDAD], RESPECTO DEL [SERVICIO] IDENTIFICADO CON CUPS [CUPS], FACTURADO POR [VALOR o "EL VALOR INDICADO EN EL EXPEDIENTE"]". Si conoces valor reconocido, agrégalo: "Y RECONOCIDO SOLO POR [VALOR]". Si tienes datos del PDF (paciente, médico, fechas, folio), ciérralo con ", CORRESPONDIENTE AL PACIENTE [NOMBRE], CON INGRESO DEL [FECHA] Y PROCEDIMIENTO REGISTRADO EN HISTORIA CLÍNICA FOLIO [N]". 🚫 NUNCA escribas "RESPETUOSAMENTE" en esta primera frase.

PÁRRAFO 2 — REFUTACIÓN FÁCTICA ENUMERADA: Abre SIEMPRE con "LA AFIRMACIÓN DE LA AUDITORÍA DE QUE [motivo exacto de la EPS, citado textualmente] NO SE AJUSTA A [LA REALIDAD CONTRACTUAL / LOS SOPORTES CLÍNICOS / LA NORMATIVA APLICABLE] POR LAS SIGUIENTES RAZONES:". Luego enumera OBLIGATORIAMENTE con "EN PRIMER LUGAR, ... EN SEGUNDO LUGAR, ... EN TERCER LUGAR, ...". Cada argumento 2-3 oraciones técnicas del caso.

PÁRRAFO 3 — FUNDAMENTO NORMATIVO Y CONTRACTUAL: Cita 3-4 normas en orden: (a) artículo + código/ley + contenido; (b) contrato específico con número, vigencia, partes; (c) régimen especial si aplica (PPL/FOMAG/FF.MM./ARL). Usa SIEMPRE conectores técnicos: "DE CONFORMIDAD CON", "A LA LUZ DEL ARTÍCULO", "POR SU PARTE", "ADICIONALMENTE", "EN IDÉNTICO SENTIDO", "TRATÁNDOSE DE". Cada norma debe explicar POR QUÉ refuerza la posición de la IPS.

PÁRRAFO 4 — PETICIÓN CONCILIADORA + RESERVA DE DERECHOS + CONTACTO: Termina EXACTAMENTE con:
"EN ESE ORDEN DE IDEAS, SE SOLICITA RESPETUOSAMENTE A LA ENTIDAD PAGADORA EL LEVANTAMIENTO DE LA GLOSA [CÓDIGO] Y EL RECONOCIMIENTO ÍNTEGRO DEL VALOR FACTURADO, CONFORME AL MARCO CONTRACTUAL Y NORMATIVO ANTES CITADO. EN CASO DE PERSISTIR LA OBJECIÓN, LA ESE HUS INVITA A MESA DE CONCILIACIÓN DE AUDITORÍA CONFORME AL ARTÍCULO 20 DEL DECRETO 4747 DE 2007, RESERVÁNDOSE EL DERECHO DE ELEVAR EL CONFLICTO ANTE LA SUPERINTENDENCIA NACIONAL DE SALUD SEGÚN LO DISPUESTO EN EL ARTÍCULO 126 DE LA LEY 1438 DE 2011. CUALQUIER COMUNICACIÓN SOBRE LA PRESENTE DEFENSA SE RECIBIRÁ EN LOS CORREOS INSTITUCIONALES CARTERA@HUS.GOV.CO Y GLOSASYDEVOLUCIONES@HUS.GOV.CO, O EN LA VENTANILLA ÚNICA DE LA ESE HUS, CARRERA 33 No. 28-126, BUCARAMANGA."
