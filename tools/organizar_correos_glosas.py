...
CONFIG_DEFECTO: dict = {
    ...
    "entidades": [
        ...
        {
            "carpeta": "SAVIA SALUD",
            "remitente": ["SAVIASALUD", "SAVIA"],
            "asunto": ["SAVIA\\s+SALUD"],
            "adjuntos": [],
        },
        {
            "carpeta": "POSITIVA",
            "remitente": ["POSITIVA"],
            "asunto": ["POSITIVA COMPAÑIA", "POSITIVA SEGUROS"],
            "adjuntos": [],
        },
        {
            "carpeta": "FOMAG",
            "remitente": ["FOMAG", "FIDUPREVISORA"],
            "asunto": ["FOMAG", "MAGISTERIO"],
            "adjuntos": [],
        },
        {
            "carpeta": "MUTUAL",
        ...
        {
            "carpeta": "POLICIA",
            "remitente": ["POLICIA\\.GOV\\.CO", "DISAN"],
            "asunto": ["POLICIA NACIONAL", "SANIDAD POLICIA"],
            "adjuntos": ["^GLOSA A RAD"],
        },
        {
            "carpeta": "SANITAS",
            "remitente": ["SANITAS"],
