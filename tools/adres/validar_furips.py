...
NATURALEZAS_EVENTO = {
    ...
    "13", "14", "15", "16", "17", "25", "26", "27",
}
TIPOS_VEHICULO = {"1", "2", "3", "4", "5", "6", "7", "8", "10", "14", "17", "19", "20", "21", "22"}
ESTADOS_ASEGURAMIENTO = {"1", "2", "3", "4", "6", "7", "8"}
NOMBRE_ESTADO_ASEG = {
    "1": "Asegurado", "2": "No asegurado", "3": "Vehículo fantasma", "4": "Póliza falsa",
    "6": "Asegurado D.2497", "7": "No aseg. propietario indeterminado", "8": "No asegurado sin placa",
}
TIPOS_SERVICIO_F2 = {
    "1": "Medicamentos", "2": "Procedimientos", "3": "Transporte primario",
    "4": "Transporte secundario", "5": "Insumos", "6": "Dispositivos médicos",
    "7": "Material de osteosíntesis", "8": "Procedimiento fuera de manual tarifario",
}
...
E1 = [
    ...
    (2, "I. Datos de la reclamación", "RGO Respuesta a glosa u objeción", 1, None, {"0", "1", "6"}, "NO"),
    (3, "I. Datos de la reclamación", "Número de factura", 20, None, None, "SI"),
    (4, "I. Datos de la reclamación", "Número consecutivo de la reclamación", 12, "num", None, "SI"),
    ...
    (10, "III. Datos de la víctima", "Tipo de documento de la víctima", 2, None, TIPOS_DOC_VICTIMA, "SI"),
    ...
    (15, "III. Datos de la víctima", "Dirección de residencia de la víctima", 100, None, None, "SI"),
    ...
    (19, "III. Datos de la víctima", "Condición de la víctima", 1, None, {"1", "2", "3", "4"}, "C_NAT01"),
    ...
    (28, "V. Vehículo involucrado", "Estado de aseguramiento", 1, None, ESTADOS_ASEGURAMIENTO, "C_NAT01"),
    ...
    (34, "V. Vehículo involucrado", "Fecha inicio vigencia póliza", 10, "fecha", None, "C_VEH_POLIZA"),
    (35, "V. Vehículo involucrado", "Fecha final vigencia póliza", 10, "fecha", None, "C_VEH_POLIZA"),
    (36, "V. Vehículo involucrado", "Número de radicado SIRAS (id_atencion)", 20, None, None, "C_NAT01"),
    (37, "V. Vehículo involucrado", "Cobro por agotamiento tope aseguradora", 1, None, {"0", "1"}, "C_NAT01"),
    (38, "VI. Atención de la víctima", "CUPS servicio principal hospitalización", 6, None, None, "NO"),
    (39, "VI. Atención de la víctima", "Complejidad del procedimiento quirúrgico", 1, None, {"1", "2", "3"}, "C_QX"),
    (40, "VI. Atención de la víctima", "CUPS procedimiento quirúrgico principal", 6, None, None, "C_QX"),
    (41, "VI. Atención de la víctima", "CUPS procedimiento quirúrgico secundario", 6, None, None, "NO"),
    ...
    (44, "VII. Propietario del vehículo", "Tipo documento del propietario", 3, None, TIPOS_DOC_PROPIETARIO, "C_PROP"),
    (45, "VII. Propietario del vehículo", "Número documento del propietario", 16, None, None, "C_PROP"),
    (46, "VII. Propietario del vehículo", "Primer apellido del propietario o razón social", 40, None, None, "C_PROP"),
    (47, "VII. Propietario del vehículo", "Segundo apellido del propietario", 30, None, None, "NO"),
    (48, "VII. Propietario del vehículo", "Primer nombre del propietario", 20, None, None, "C_PROP_NAT"),
    (49, "VII. Propietario del vehículo", "Segundo nombre del propietario", 30, None, None, "NO"),
    (50, "VII. Propietario del vehículo", "Dirección de residencia del propietario", 200, None, None, "C_PROP"),
    (51, "VII. Propietario del vehículo", "Teléfono del propietario", 10, None, None, "NO"),
    (52, "VII. Propietario del vehículo", "Código departamento residencia propietario", 2, "depto", None, "C_PROP"),
    (53, "VII. Propietario del vehículo", "Código municipio residencia propietario", 3, "mun", None, "C_PROP"),
    ...
    (58, "VIII. Conductor del vehículo", "Tipo documento del conductor", 2, None, TIPOS_DOC_CONDUCTOR, "C_COND"),
    (59, "VIII. Conductor del vehículo", "Número documento del conductor", 16, None, None, "C_COND"),
    (60, "VIII. Conductor del vehículo", "Dirección de residencia del conductor", 200, None, None, "C_COND"),
    (61, "VIII. Conductor del vehículo", "Código departamento residencia conductor", 2, "depto", None, "C_COND"),
    (62, "VIII. Conductor del vehículo", "Código municipio residencia conductor", 3, "mun", None, "C_COND"),
    ...
    (67, "IX. Datos de remisión", "Código habilitación prestador remitente", 12, "num", None, "C_REMISION"),
    ...
    (72, "IX. Datos de remisión", "Código habilitación prestador que recibe", 12, "num", None, "C_REMISION"),
    (73, "IX. Datos de remisión", "Profesional que recibe", 60, None, None, "C_REMISION"),
    (74, "IX. Datos de remisión", "Placa ambulancia traslado interinstitucional", 6, "placa", None, "C_REMISION"),
    (75, "X. Transporte de la víctima", "Placa ambulancia traslado primario", 6, "placa", None, "C_TRANSP"),
    (76, "X. Transporte de la víctima", "Transporte de la víctima desde", 40, None, None, "C_TRANSP"),
    (77, "X. Transporte de la víctima", "Transporte de la víctima hasta", 40, None, None, "C_TRANSP"),
    (78, "X. Transporte de la víctima", "Tipo de servicio del transporte", 1, None, {"1", "2"}, "C_TRANSP"),
    ...
    (84, "XI. Certificación de la atención", "Diagnóstico principal de ingreso", 4, "cie10", None, "SI"),
    (85, "XI. Certificación de la atención", "Diagnóstico de ingreso asociado 1", 4, "cie10", None, "NO"),
    (86, "XI. Certificación de la atención", "Diagnóstico de ingreso asociado 2", 4, "cie10", None, "NO"),
    (87, "XI. Certificación de la atención", "Diagnóstico principal de egreso", 4, "cie10", None, "SI"),
    (88, "XI. Certificación de la atención", "Diagnóstico de egreso asociado 1", 4, "cie10", None, "NO"),
    (89, "XI. Certificación de la atención", "Diagnóstico de egreso asociado 2", 4, "cie10", None, "NO"),
    ...
    (94, "XII. Médico o profesional tratante", "Tipo documento del médico", 2, None, TIPOS_DOC_MEDICO, "SI"),
    (95, "XII. Médico o profesional tratante", "Número documento del médico", 16, None, None, "SI"),
    (96, "XII. Médico o profesional tratante", "Número de registro del médico", 16, None, None, "SI"),
    (97, "XIII. Amparos que reclama", "Total facturado gastos médico-quirúrgicos", 15, "num", None, "SI"),
    (98, "XIII. Amparos que reclama", "Total reclamado gastos médico-quirúrgicos", 15, "num", None, "SI"),
    (99, "XIII. Amparos que reclama", "Total facturado transporte y movilización", 15, "num", None, "SI"),
    (100, "XIII. Amparos que reclama", "Total reclamado transporte y movilización", 15, "num", None, "SI"),
    (101, "XIV. Declaración del prestador", "Manifestación de servicios habilitados", 3, None, {"0", "1"}, "SI"),
...
def extraer_montos(texto: str) -> set[int]:
    ...
    for m in re.finditer(r"\$?\s*([\d]{1,3}(?:[.,][\d]{3})*(?:[.,]\d{2})?|\d{4,})", texto):
        ...
        if re.search(r"[.,]\d{2}$", limpio) and ("." in limpio[:-3] or "," in limpio[:-3] or len(limpio) > 6):
            limpio = limpio[:-3]
...
class ResultadoFactura:
    ...
    def agregar(self, origen: str, severidad: str, campo: str, concepto: str,
                valor_furips: str, regla: str, detalle: str = "",
                valor_soporte: str = "", fuente: str = "") -> None:
        self.hallazgos.append(Hallazgo(
            factura=self.factura, origen=origen, severidad=severidad, campo=str(campo),
            concepto=concepto, valor_furips=valor_furips, valor_soporte=valor_soporte,
            fuente=fuente, regla=regla, detalle=detalle,
        ))
...
def _hay_lineas_quirurgicas(lineas_f2: list[list[str]]) -> bool:
    ...
    for ln in lineas_f2:
        if ln[2] == "2" and a_entero(ln[5]) == 0 and a_entero(ln[7]) == 0:
            return True
    return False
...
def validar_malla_f1(res: ResultadoFactura) -> None:
    reg = res.registro_f1
    if reg is None:
        res.agregar("ESTRUCTURA", ERROR, "-", "Registro FURIPS 1",
                    "", "Circular 022/2023",
    ...
    for (n, seccion, nombre, longitud, formato, permitidos, oblig) in E1:
        valor = c.get(n, "")
        estado, obs = OK, ""
        ...
        if debe_vacio and valor:
            estado = ERROR
            obs = (f"Debe estar VACÍO cuando el vehículo es fantasma (28=3) "
                   f"y tiene '{valor}'.")
            ...
            if formato == "fecha" and not parse_fecha_ddmmaaaa(valor):
                ...
                if not (len(valor) == 2 and valor.isdigit()):
                    ...
                    estado = ERROR
                    obs = (obs + " " if obs else "") + f"'{valor}' no es un departamento DANE válido."
            elif formato == "mun" and not (len(valor) == 3 and valor.isdigit()):
                estado = ERROR
                obs = (obs + " " if obs else "") + f"'{valor}' no es código DANE de municipio (3 dígitos)."
        ...
        if estado in (ERROR, ADVERTENCIA):
            res.agregar("MALLA FURIPS1", estado, n, nombre, valor,
...
def _validar_coherencia_f1(res: ResultadoFactura, c: dict[int, str], ctx: dict) -> None:
    ...
    if f_ingreso and f_egreso:
        ...
        if dt_eg < dt_in:
            res.agregar("MALLA FURIPS1", ERROR, "80-83", "Fechas de ingreso/egreso",
    ...
    if f_evento and f_ingreso and f_ingreso < f_evento:
        res.agregar("MALLA FURIPS1", ERROR, "23/80", "Fecha evento vs fecha ingreso",
    ...
    if f_nac:
        if f_evento and f_nac > f_evento:
            res.agregar("MALLA FURIPS1", ERROR, "12/23", "Fecha nacimiento vs evento",
            ...
            if tipo_doc == "TI" and edad >= 18:
                res.agregar("MALLA FURIPS1", ADVERTENCIA, "10/12", "Tipo doc vs edad",
                            f"TI con {edad} años",
    ...
    if c.get(19, "") == "1" and c.get(59, ""):
        if c.get(59) != c.get(11):
            res.agregar("MALLA FURIPS1", ADVERTENCIA, "19/59", "Víctima conductora vs conductor",
            ...
            res.agregar("MALLA FURIPS1", ADVERTENCIA, "10/58", "Tipo doc víctima vs conductor",
    ...
    if f_evento and f_v1 and f_v2 and not (f_v1 <= f_evento <= f_v2):
        res.agregar("MALLA FURIPS1", ADVERTENCIA, "34/35", "Vigencia póliza vs evento",
    ...
    if dias_uci and f_ingreso and f_egreso:
        ...
        if dias_uci > max(estancia, 1):
            res.agregar("MALLA FURIPS1", ERROR, "43", "Días de UCI vs estancia",
    ...
    if c.get(37, "") == "1" and c.get(28, "") != "6":
        res.agregar("MALLA FURIPS1", ADVERTENCIA, "37", "Cobro agotamiento tope",
    ...
    if c.get(101, "") == "0":
        res.agregar("MALLA FURIPS1", ADVERTENCIA, "101", "Manifestación de servicios habilitados",
                    "0", "Circular 022/2023 campo 101",
    ...
    if c.get(28, "") == "7" and not c.get(54, ""):
        res.agregar("MALLA FURIPS1", ADVERTENCIA, "54-63", "Datos del conductor",
...
def validar_furips2(res: ResultadoFactura) -> None:
    ...
    if not res.lineas_f2:
        if reg:
            res.agregar("FURIPS2", ERROR, "-", "Líneas FURIPS 2", "",
    ...
    for i, ln in enumerate(res.lineas_f2, 1):
        ...
        if tipo == "1" and codigo and not re.match(r"^\d+-\d+$|^\d{4,}$", codigo):
            partes.append((ADVERTENCIA,
                           f"Código '{codigo}' no parece CUM (expediente-consecutivo) ni IUM."))
        if tipo in {"3", "4", "5", "6", "7", "8"} and not descripcion:
            partes.append((ERROR, f"Descripción obligatoria para tipo de servicio {tipo}."))

        n_cant, n_unit, n_fact, n_recl = (a_entero(cantidad), a_entero(vr_unit),
                                          a_entero(vr_fact), a_entero(vr_recl))
        for etiqueta, crudo, num in (("cantidad", cantidad, n_cant), ("valor unitario", vr_unit, n_unit),
                                     ("valor facturado", vr_fact, n_fact), ("valor reclamado", vr_recl, n_recl)):
            if crudo == "" or num is None:
                partes.append((ERROR, f"{etiqueta.capitalize()} '{crudo}' no es numérico u obligatorio."))
            elif "." in crudo or "," in crudo:
                partes.append((ERROR, f"{etiqueta.capitalize()} '{crudo}' trae separadores/decimales."))
        ...
        if None not in (n_cant, n_unit, n_fact):
            if not es_linea_principal_qx and n_cant <= 0:
                partes.append((ERROR, "Cantidad debe ser mayor a cero (salvo línea principal quirúrgica)."))
        ...
        estado = (ERROR if any(s == ERROR for s, _ in partes) else
                  ADVERTENCIA if partes else OK)
    ...
    for (sev, _patron), casos in grupos.items():
        ...
        tipo0 = casos[0][2]
        concepto = (f"{len(casos)} línea(s) — tipo {tipo0} {TIPOS_SERVICIO_F2.get(tipo0, '')}"
                    if len(tipos_grupo) == 1 else f"{len(casos)} línea(s)")
        res.agregar("FURIPS2", sev, lineas_txt, concepto,
                    casos[0][1][:60], "Circular 022/2023 Tabla 2",
                    casos[0][1] + (f" (Aplica a {len(casos)} líneas: {lineas_txt}. "
                                   f"Ver detalle en la hoja FURIPS2 LINEAS.)"
                                   if len(casos) > 1 else f" (Línea {casos[0][0]}.)"))
...
def _validar_sumatorias(res: ResultadoFactura, reg: list[str]) -> None:
    ...
    for campo, clave, nombre in comparaciones:
        ...
        if declarado != suma[clave]:
            res.agregar("FURIPS2", ERROR, str(campo), nombre,
                        f"{declarado:,}", "Circular 022/2023 campos 97-100",
                        f"El FURIPS 1 declara {declarado:,} pero la sumatoria de las líneas "
                        f"FURIPS 2 da {suma[clave]:,} (diferencia {declarado - suma[clave]:,}).",
                        valor_soporte=f"{suma[clave]:,}", fuente="FURIPS 2")

    recl, fact = a_entero(reg[97]), a_entero(reg[96])
    if recl is not None and fact is not None and recl > fact:
        res.agregar("MALLA FURIPS1", ERROR, "97/98", "Reclamado vs facturado",
                    f"facturado {fact:,} / reclamado {recl:,}",
                    "Circular 022/2023", "El total reclamado supera el total facturado.")
...
# ─────────────────────────────────────────────────────────────────────────────
TOKENS_SOPORTE = {
    "RIP": "RIPS JSON", "RIPS": "RIPS JSON", "CUV": "CUV JSON",
    "FACTURA": "FACTURA", "FEV": "FACTURA XML", "EPICRIS": "EPICRISIS",
    "EPI": "EPICRISIS", "HEV": "HOJA EVOLUCIÓN", "HAU": "HOJA URGENCIAS",
    "INFOPOL": "INFORME POLICIAL", "IPO": "INFORME POLICIAL",
    "DQX": "DESCRIPCIÓN QUIRÚRGICA", "RAN": "REGISTRO ANESTESIA",
    "TAP": "TRASLADO ASISTENCIAL", "FMO": "FACT. OSTEOSÍNTESIS",
    "OPF": "ORDEN FACULTATIVA", "PDX": "APOYO DIAGNÓSTICO",
    "HAM": "ADMIN. MEDICAMENTOS", "CRC": "COMPROBANTE RECIBIDO",
}
...
def analizar_carpeta(res: ResultadoFactura, sin_pdf: bool = False) -> None:
    ...
    carpeta = res.carpeta
    if carpeta is None:
        res.agregar("SOPORTES", ADVERTENCIA, "-", "Carpeta de soportes", "",
                    "Res. 2284/2023", "No se encontró carpeta de soportes para esta factura.")
        return
    ...
    for p in sorted(carpeta.iterdir()):
        ...
        if tipo not in encontrados:
            encontrados[tipo] = p
        res.soportes.append({
            "archivo": p.name, "tipo": tipo, "bytes": p.stat().st_size,
            "legible": legible, "obs": obs,
        })
    ...
    if "RIPS JSON" in encontrados:
        ...
        if rips:
            ...
            res.agregar("SOPORTES", ERROR, "-", "RIPS JSON",
                        encontrados["RIPS JSON"].name, "Res. 2284/2023",
                        "El RIPS no se pudo parsear como JSON.")
    else:
        res.agregar("SOPORTES", ERROR, "-", "RIPS JSON", "", "Res. 2284/2023",
    ...
    if "CUV JSON" in encontrados:
        ...
        if cuv:
            ...
            res.agregar("SOPORTES", ERROR, "-", "CUV JSON",
                        encontrados["CUV JSON"].name, "Res. 2284/2023",
                        "El CUV no se pudo parsear como JSON.")
    else:
        res.agregar("SOPORTES", ERROR, "-", "CUV JSON", "", "Res. 2284/2023",
    ...
    if "FACTURA XML" in encontrados:
        ...
        res.agregar("SOPORTES", ERROR, "-", "Factura electrónica XML", "", "Res. 2284/2023",
    ...
    for tipo, etiqueta in (("FACTURA PDF", "factura_pdf"), ("EPICRISIS", "epicrisis")):
        if tipo not in encontrados:
            ...
            res.agregar("SOPORTES", severidad, "-", tipo, "", "Res. 2284/2023",
                        f"FALTA el soporte {tipo} en la carpeta." +
                        (" (La epicrisis/resumen de atención es soporte obligatorio.)"
                         if tipo == "EPICRISIS" else ""))
            continue
        if sin_pdf:
            continue
        if motor == "ninguno":
            res.agregar("SOPORTES", ADVERTENCIA, "-", tipo, encontrados[tipo].name,
                        "Dependencias", "No hay librería PDF instalada (pdfplumber o pypdf): "
        ...
        if len(texto.strip()) <= 50:
            res.agregar("SOPORTES", ADVERTENCIA, "-", tipo, encontrados[tipo].name,
                        "Legibilidad", f"El PDF ({paginas} páginas) no tiene capa de texto "
...
def _leer_fev(ruta: Path) -> dict:
    ...
    m = re.search(
        r"AccountingSupplierParty.*?<(?:\w+:)?CompanyID[^>]*>([^<]+)<", texto, re.DOTALL)
    ...
    m = re.search(
        r"LegalMonetaryTotal.*?<(?:\w+:)?PayableAmount[^>]*>([^<]+)<", texto, re.DOTALL)
...
def _agregar_cruce(res: ResultadoFactura, dato: str, valor_furips: str,
                   valores: dict[str, str], resultado: str, obs: str = "") -> None:
    res.cruces.append({
        "dato": dato, "furips": valor_furips,
        "rips": valores.get("rips", ""), "cuv": valores.get("cuv", ""),
        "xml": valores.get("xml", ""), "factura_pdf": valores.get("factura_pdf", ""),
...
def cruzar_soportes(res: ResultadoFactura) -> None:
    ...
    # ── Número de factura ────────────────────────────────────────────────────
    valores = {
        "rips": rips.get("numFactura", ""), "cuv": cuv.get("NumFactura", ""),
        "xml": fev.get("num_factura", ""),
        "factura_pdf": "presente" if fac_legible and norm_factura(c[3]) in txt_fac.replace(" ", "") else
        ("" if not fac_legible else "NO ENCONTRADO"),
    }
    difs = [f for f in ("rips", "cuv", "xml") if valores[f] and norm_factura(valores[f]) != norm_factura(c[3])]
    if difs or valores["factura_pdf"] == "NO ENCONTRADO":
        fuentes = ", ".join(difs + (["factura PDF"] if valores["factura_pdf"] == "NO ENCONTRADO" else []))
        _agregar_cruce(res, "Número de factura", c[3], valores, "DIFERENCIA",
                       f"No coincide en: {fuentes}")
        res.agregar("CRUCE FEV XML" if "xml" in difs else "CRUCE RIPS", ERROR, "3",
                    "Número de factura", c[3],
    ...
    valores = {
        ...
        "factura_pdf": "" if not fac_legible else ("presente" if doc and doc in txt_fac else "NO ENCONTRADO"),
        "epicrisis": "" if not epi_legible else ("presente" if doc and doc in txt_epi else "NO ENCONTRADO"),
    }
    problemas = []
    if usuario:
        ...
        if usuario.get("tipoDocumentoIdentificacion", "") and \
                usuario.get("tipoDocumentoIdentificacion") != c[10]:
            problemas.append(
    ...
    if problemas:
        _agregar_cruce(res, "Documento de la víctima", f"{c[10]} {doc}", valores,
                       "DIFERENCIA", "; ".join(problemas))
        res.agregar("CRUCE RIPS" if usuario else "CRUCE EPICRISIS", ERROR, "10/11",
                    "Documento de la víctima", f"{c[10]} {doc}",
                    "Cruce FURIPS vs soportes", "; ".join(problemas) + ".",
                    valor_soporte=valores["rips"], fuente="RIPS/PDFs")
    else:
    ...
    valores = {
        "factura_pdf": "" if not fac_legible else ("presente" if _nombres_en_texto(nombres, txt_fac) else "NO ENCONTRADO"),
        "epicrisis": "" if not epi_legible else ("presente" if _nombres_en_texto(nombres, txt_epi) else "NO ENCONTRADO"),
    }
    problemas = [f"nombre no aparece completo en {k.replace('_', ' ')}"
                 for k in ("factura_pdf", "epicrisis") if valores[k] == "NO ENCONTRADO"]
    if problemas:
        _agregar_cruce(res, "Nombre de la víctima", nombre_completo, valores, "DIFERENCIA",
                       "; ".join(problemas))
        res.agregar("CRUCE EPICRISIS", ADVERTENCIA, "6-9", "Nombre de la víctima",
                    nombre_completo, "Cruce FURIPS vs soportes",
    ...
    if usuario:
        ...
        if f_nac_f and f_nac_r and f_nac_f != f_nac_r:
            _agregar_cruce(res, "Fecha de nacimiento", c[12],
                           {"rips": usuario.get("fechaNacimiento", "")}, "DIFERENCIA")
            res.agregar("CRUCE RIPS", ERROR, "12", "Fecha de nacimiento", c[12],
                        "Cruce FURIPS vs RIPS",
                        f"FURIPS dice {c[12]} y el RIPS {usuario.get('fechaNacimiento')}.",
                        valor_soporte=usuario.get("fechaNacimiento", ""), fuente="RIPS")
        elif f_nac_f and f_nac_r:
            _agregar_cruce(res, "Fecha de nacimiento", c[12],
                           {"rips": usuario.get("fechaNacimiento", "")}, "COINCIDE")
        ...
        if sexo_r and c[14] and sexo_r != c[14]:
            ...
            res.agregar("CRUCE RIPS", ERROR, "14", "Sexo de la víctima", c[14],
                        "Cruce FURIPS vs RIPS", f"FURIPS dice {c[14]} y el RIPS {sexo_r}.",
                        valor_soporte=sexo_r, fuente="RIPS")
        elif sexo_r:
    ...
    if cod_prest_rips:
        ...
        if r == "DIFERENCIA":
            res.agregar("CRUCE RIPS", ERROR, "5", "Código de habilitación", c[5],
                        "Cruce FURIPS vs RIPS",
                        f"FURIPS dice {c[5]} y el RIPS {cod_prest_rips}.",
                        valor_soporte=cod_prest_rips, fuente="RIPS")
    ...
    if nit_rips and nit_xml:
        ...
        if r == "DIFERENCIA":
            res.agregar("CRUCE FEV XML", ADVERTENCIA, "-", "NIT del prestador", nit_xml,
                        "Cruce RIPS vs FEV", f"RIPS declara NIT {nit_rips} y el XML {nit_xml}.",
                        valor_soporte=nit_rips, fuente="RIPS/XML")
    ...
    fechas_fac = extraer_fechas((datos.get("factura_pdf") or {}).get("texto", "")) if fac_legible else set()
    fechas_epi = extraer_fechas((datos.get("epicrisis") or {}).get("texto", "")) if epi_legible else set()
    valores = {
        "rips": proc0.get("fechaInicioAtencion", "") if proc0 else "",
        "factura_pdf": "" if not fac_legible else ("presente" if f_ing in fechas_fac else "NO ENCONTRADA"),
        "epicrisis": "" if not epi_legible else ("presente" if f_ing in fechas_epi else "NO ENCONTRADA"),
    }
    problemas = []
    ...
    if problemas:
        _agregar_cruce(res, "Fecha de ingreso", f"{c[80]} {c[81]}", valores, "DIFERENCIA",
                       "; ".join(problemas))
        res.agregar("CRUCE EPICRISIS", ADVERTENCIA if not (f_ing and fechas_rips and f_ing != fechas_rips) else ERROR,
                    "80", "Fecha de ingreso", f"{c[80]} {c[81]}",
                    "Cruce FURIPS vs soportes (XI: los datos deben coincidir con el soporte)",
                    "; ".join(problemas) + ".", valor_soporte=valores["rips"], fuente="RIPS/PDFs")
    elif f_ing:
    ...
    if f_evento and epi_legible:
        ...
        _agregar_cruce(res, "Fecha del evento/accidente", c[23],
                       {"epicrisis": "presente" if r == "COINCIDE" else "NO ENCONTRADA"}, r)
        if r != "COINCIDE":
            res.agregar("CRUCE EPICRISIS", ADVERTENCIA, "23", "Fecha del evento", c[23],
    ...
    for campo, nombre in ((84, "Diagnóstico principal de ingreso"), (87, "Diagnóstico principal de egreso")):
        dx = normalizar(c[campo])
        if not dx:
            continue
        valores = {
            "rips": dx_rips,
            "epicrisis": "" if not epi_legible else (
                "presente" if (dx in txt_epi or f"{dx[:3]}.{dx[3:]}" in txt_epi) else "NO ENCONTRADO"),
        }
        problemas = []
        ...
        if problemas:
            ...
            res.agregar("CRUCE RIPS" if (dx_rips and campo == 84 and dx_rips != dx) else "CRUCE EPICRISIS",
                        ADVERTENCIA, str(campo), nombre, dx,
                        "Cruce FURIPS vs soportes", "; ".join(problemas) + ".",
                        valor_soporte=dx_rips, fuente="RIPS/EPICRISIS")
        else:
    ...
    suma_rips = sum(
        ...
        for tipo in ("consultas", "procedimientos", "medicamentos", "otrosServicios",
                     "urgencias", "hospitalizacion")
        for p in ((u.get("servicios") or {}).get(tipo) or [])
    ) if rips else None
    montos_fac = extraer_montos((datos.get("factura_pdf") or {}).get("texto", "")) if fac_legible else set()
    valores = {
        "rips": f"{suma_rips:,}" if suma_rips else "",
        "xml": f"{total_xml:,}" if total_xml is not None else "",
        "factura_pdf": "" if not fac_legible else (
            "presente" if total_fact in montos_fac else "NO ENCONTRADO"),
    }
    problemas = []
    ...
    if problemas:
        _agregar_cruce(res, "Total facturado (97+99)", f"{total_fact:,}", valores, "DIFERENCIA",
                       "; ".join(problemas))
        res.agregar("CRUCE FEV XML", ERROR if (total_xml is not None and total_xml != total_fact) else ADVERTENCIA,
                    "97/99", "Total facturado vs soportes", f"{total_fact:,}",
                    "Cruce FURIPS vs factura/RIPS",
                    f"FURIPS declara {total_fact:,} pero " + "; ".join(problemas) + ".",
                    valor_soporte=valores["xml"] or valores["rips"], fuente="XML/RIPS/PDF")
    else:
    ...
    if fac_legible and c[4]:
        ...
        _agregar_cruce(res, "Consecutivo reclamación (ingreso)", c[4],
                       {"factura_pdf": "presente" if r == "COINCIDE" else "NO ENCONTRADO"}, r)
        if r == "NO ENCONTRADO":
            res.agregar("CRUCE FACTURA PDF", ADVERTENCIA, "4", "Consecutivo de la reclamación",
                        c[4], "Cruce FURIPS vs factura PDF",
    ...
    lineas_con_codigo = [(i, ln) for i, ln in enumerate(res.lineas_f2, 1)
                         if ln[2] in {"1", "2", "6"} and ln[3]]
    if items_xml and lineas_con_codigo:
        codigos_xml = {normalizar(k) for k in items_xml}
        coincidencias = sum(1 for _i, ln in lineas_con_codigo
                            if normalizar(ln[3]) in codigos_xml)
        if coincidencias >= max(1, len(lineas_con_codigo) // 3):
            faltantes = [(i, ln) for i, ln in lineas_con_codigo
                         if normalizar(ln[3]) not in codigos_xml]
            for i, ln in faltantes[:20]:
                res.agregar("CRUCE FEV XML", ADVERTENCIA, f"F2 L{i}",
                            "Código de servicio vs factura XML", ln[3],
                            "Cruce FURIPS2 vs FEV",
                            f"El código '{ln[3]}' de la línea {i} del FURIPS 2 no aparece "
                            f"como ítem de la factura electrónica.",
                            valor_soporte=", ".join(sorted(codigos_xml)[:8]), fuente="FEV XML")
        else:
            res.agregar("CRUCE FEV XML", INFO, "-", "Codificación de la factura XML",
    ...
    if cuv:
        ...
        if not codigo_cuv:
            res.agregar("CRUCE CUV", ERROR, "-", "Código único de validación", "",
                        "Res. 2284/2023", "El CUV no contiene CodigoUnicoValidacion.")
        if cuv.get("ResultState") is False:
            res.agregar("CRUCE CUV", ERROR, "-", "Estado de validación RIPS",
                        "ResultState=false", "MSPS",
                        "El Ministerio NO validó exitosamente el RIPS (ResultState=false).")
        rechazos = [r for r in (cuv.get("ResultadosValidacion") or [])
                    if normalizar(str(r.get("Clase", ""))) == "RECHAZO"]
        notifs = [r for r in (cuv.get("ResultadosValidacion") or [])
                  if normalizar(str(r.get("Clase", ""))) == "NOTIFICACION"]
        if rechazos:
            res.agregar("CRUCE CUV", ERROR, "-", "Rechazos en validación RIPS",
                        f"{len(rechazos)} rechazo(s)", "MSPS",
                        "; ".join(f"{r.get('Codigo')}: {r.get('Descripcion', '')[:80]}"
                                  for r in rechazos[:5]))
        if notifs:
            res.agregar("CRUCE CUV", INFO, "-", "Notificaciones validación RIPS",
                        f"{len(notifs)} notificación(es)", "MSPS",
                        "; ".join(f"{r.get('Codigo')}" for r in notifs[:10]) +
                        ". Son avisos del validador RIPS, no impiden radicar.")
        _agregar_cruce(res, "CUV (validación RIPS MSPS)",
...
# Informe Excel
# ─────────────────────────────────────────────────────────────────────────────
def generar_excel(resultados: list[ResultadoFactura], obs_archivos: list[str],
                  salida: Path) -> None:
    ...
    def hoja(nombre, encabezados, anchos):
        ...
        for j, (enc, ancho) in enumerate(zip(encabezados, anchos), 1):
    ...
    # ── RESUMEN ──────────────────────────────────────────────────────────────
    ws = hoja("RESUMEN", [
        "FACTURA", "CONSECUTIVO", "PACIENTE", "DOCUMENTO", "FECHA EVENTO",
        "INGRESO", "EGRESO", "VR FACTURADO", "VR RECLAMADO", "LÍNEAS F2",
        "FURIPS1", "CARPETA", "RIPS", "CUV", "FEV XML", "FACT. PDF", "EPICRISIS",
        "ERRORES", "ADVERT.", "ESTADO", "PRINCIPALES HALLAZGOS",
    ...
    for res in resultados:
        ...
        estado = ("CON ERRORES" if res.errores else
                  "REVISAR" if res.advertencias else "CUMPLE")
        principales = "; ".join(
        ...
        fila(ws, [
            res.factura, c.get(4, ""), paciente, f"{c.get(10, '')} {c.get(11, '')}".strip(),
            c.get(23, ""), f"{c.get(80, '')} {c.get(81, '')}".strip(),
            ...
            len(res.lineas_f2), "SI" if reg else "FALTA",
            "SI" if res.carpeta else "FALTA",
            sop("RIPS JSON"), sop("CUV JSON"), sop("FACTURA XML"),
            sop("FACTURA PDF"), sop("EPICRISIS"),
            res.errores, res.advertencias, estado, principales,
        ], col_estado=20, estado=(ERROR if estado == "CON ERRORES" else
                                  ADVERTENCIA if estado == "REVISAR" else OK),
            cols_moneda=(8, 9))
    ws.auto_filter.ref = f"A1:U{ws.max_row}"

    # ── HALLAZGOS ────────────────────────────────────────────────────────────
    ws = hoja("HALLAZGOS", [
        "FACTURA", "ORIGEN", "SEVERIDAD", "CAMPO Nº", "CONCEPTO",
        "VALOR FURIPS", "VALOR SOPORTE", "FUENTE", "REGLA (referencia)", "DETALLE",
    ], [14, 16, 13, 9, 30, 24, 24, 14, 30, 65])
    orden_sev = {ERROR: 0, ADVERTENCIA: 1, INFO: 2}
    todos = sorted((h for res in resultados for h in res.hallazgos),
                   key=lambda h: (h.factura, orden_sev.get(h.severidad, 3), h.origen))
    for h in todos:
        fila(ws, [h.factura, h.origen, h.severidad, h.campo, h.concepto,
                  h.valor_furips, h.valor_soporte, h.fuente, h.regla, h.detalle],
             col_estado=3, estado=h.severidad)
    for obs in obs_archivos:
        fila(ws, ["(ARCHIVOS TXT)", "ESTRUCTURA", ADVERTENCIA, "-", "Archivo FURIPS",
                  "", "", "", "Circular 022/2023 nombre/estructura", obs],
             col_estado=3, estado=ADVERTENCIA)
    ws.auto_filter.ref = f"A1:J{ws.max_row}"

    # ── FURIPS1 CAMPOS ───────────────────────────────────────────────────────
    ws = hoja("FURIPS1 CAMPOS", [
        "FACTURA", "Nº", "SECCIÓN", "CAMPO", "VALOR", "OBLIGATORIEDAD",
        "ESTADO", "OBSERVACIÓN",
    ...
    for res in resultados:
        ...
        for (n, seccion, nombre, _l, _f, _v, oblig) in E1:
            ...
            fila(ws, [res.factura, n, seccion, nombre, res.registro_f1[n - 1],
                      TEXTO_OBLIG.get(oblig, oblig), estado, obs],
                 col_estado=7, estado=estado)
    ws.auto_filter.ref = f"A1:H{ws.max_row}"

    # ── FURIPS2 LINEAS ───────────────────────────────────────────────────────
    ws = hoja("FURIPS2 LINEAS", [
        "FACTURA", "CONSECUTIVO", "LÍNEA", "TIPO SERVICIO", "CÓDIGO", "DESCRIPCIÓN",
        "CANTIDAD", "VR UNITARIO", "VR FACTURADO", "VR RECLAMADO", "ESTADO", "OBSERVACIÓN",
    ], [14, 12, 7, 22, 12, 40, 10, 12, 13, 13, 13, 50])
    for res in resultados:
        for i, ln in enumerate(res.lineas_f2, 1):
            estado, obs = (res.estado_lineas_f2[i - 1]
                           if i <= len(res.estado_lineas_f2) else (OK, ""))
            fila(ws, [res.factura, ln[1], i,
                      f"{ln[2]} - {TIPOS_SERVICIO_F2.get(ln[2], '?')}", ln[3], ln[4],
                      a_entero(ln[5]), a_entero(ln[6]), a_entero(ln[7]), a_entero(ln[8]),
                      estado, obs],
                 col_estado=11, estado=estado, cols_moneda=(8, 9, 10))
    ws.auto_filter.ref = f"A1:L{ws.max_row}"

    # ── CRUCE SOPORTES ───────────────────────────────────────────────────────
    ws = hoja("CRUCE SOPORTES", [
        "FACTURA", "DATO", "VALOR FURIPS", "RIPS", "CUV", "FACTURA XML",
        "FACTURA PDF", "EPICRISIS", "RESULTADO", "OBSERVACIÓN",
    ], [14, 28, 24, 18, 18, 18, 16, 16, 14, 45])
    for res in resultados:
        for cz in res.cruces:
            estado = OK if cz["resultado"] == "COINCIDE" else ADVERTENCIA
            fila(ws, [res.factura, cz["dato"], cz["furips"], cz["rips"], cz["cuv"],
                      cz["xml"], cz["factura_pdf"], cz["epicrisis"], cz["resultado"],
                      cz["obs"]],
                 col_estado=9, estado=estado)
    ws.auto_filter.ref = f"A1:J{ws.max_row}"

    # ── SOPORTES ─────────────────────────────────────────────────────────────
    ws = hoja("SOPORTES", [
        "FACTURA", "CARPETA", "ARCHIVO", "TIPO DE SOPORTE", "TAMAÑO (KB)",
        "TEXTO LEGIBLE", "OBSERVACIÓN",
    ], [14, 34, 44, 22, 12, 14, 40])
    for res in resultados:
        for s in res.soportes:
            fila(ws, [res.factura, str(res.carpeta or ""), s["archivo"], s["tipo"],
                      round(s["bytes"] / 1024, 1), s["legible"], s["obs"]])
        if res.carpeta is None:
            fila(ws, [res.factura, "(SIN CARPETA)", "", "", "", "",
    ...
    leyenda = [
        ...
        ("INFO (azul)", "Contexto útil que no impide radicar (ej. notificaciones del validador RIPS)."),
...
def descubrir_carpetas(raiz: Path) -> dict[str, Path]:
    ...
    for d in candidatas:
        try:
            tiene_soportes = any(
                p.is_file() and clasificar_soporte(p.name) in
                ("RIPS JSON", "CUV JSON", "FACTURA XML", "FACTURA PDF", "EPICRISIS")
                for p in d.iterdir()
            )
        except OSError:
            continue
...
def procesar(raiz: Path | None, carpeta: Path | None, furips1: Path | None,
             furips2: Path | None, sin_pdf: bool) -> tuple[list[ResultadoFactura], list[str]]:
    ...
    for clave in sorted(claves):
        ...
        if len(regs) > 1:
            res.agregar("ESTRUCTURA", ADVERTENCIA, "-", "Registros duplicados",
                        f"{len(regs)} registros", "Circular 022/2023",
...
def main() -> int:
    ...
    parser.add_argument("--raiz", type=Path, default=None,
                        help="Raíz con carpetas de factura (modo masivo)")
    parser.add_argument("--carpeta", type=Path, default=None,
                        help="Carpeta de UNA factura")
    parser.add_argument("--furips1", type=Path, default=None,
                        help="Ruta del TXT FURIPS 1 (si no, se detecta solo)")
    parser.add_argument("--furips2", type=Path, default=None,
                        help="Ruta del TXT FURIPS 2 (si no, se detecta solo)")
    parser.add_argument("--salida", type=Path, default=None,
                        help="Ruta del informe Excel (por defecto, en la raíz)")
    parser.add_argument("--sin-pdf", action="store_true",
                        help="No leer el contenido de los PDF (más rápido)")
    ...
    logger.info("")
    logger.info("=" * 72)
    logger.info(f"RESULTADO: {len(resultados)} facturas validadas — "
