...
| 15 | **AUDITAR_DEV_EPS** | Audita las devoluciones de Nueva EPS: por cada factura cruza el RIPS (JSON) con los soportes de autorización (OPF/PDE) y marca las diferencias de documento/autorización (p. ej. el documento provisional de recién nacidos). Llena el Excel de devoluciones + hoja DETALLE. |
